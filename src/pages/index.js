...
export default function Home() {
  return (
    <main>
      <div className="header_background w-full h-[500px] lg:h-[39vw] xl:h-[39vw] md:h-[43vw] sm:h-[39vw]">
        <div className="flex justify-between pt-[1vw] pl-[7vw] pr-[7.7vw] md:p-[1vw 7vw] h-[6.1vw]">
      ...
      <div className='third-sub-body2'>
        ...
        <div className='sub-body-card2 sm:grid sm:grid-cols-2 sm:gap-4 '>
          <div className='sm:col-span-1 sub-card'>
            <div className='img-position-avatar'>
              <img src='Ellipse 3.svg' width={'100px'} height={'100px'} />
            ...
            <div className='sub-body-card-d2'>
              <p>ULorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut ullamco laboris nisi ut aliquip ex ea commo.</p>
            </div>
        ...
        <div className='sub-body-card3 sm:grid sm:grid-cols-2 sm:gap-4 '>
          <div className='sm:col-span-1 sub-card'>
            <div className='img-position-avatar'>
              <img src='Ellipse 3.svg' width={'100px'} height={'100px'} />
      ...
      <div className='third-sub-body3'>
        <div className='sm:grid sm:grid-cols-2 sm:gap-4'>
          ...
          <div className='sm:col-span-1 ml-[10px]'>
            ...
            <p className='footer-p'>Whether conducting interviews or focus groups, transcript spreadsheets allow you to easily categorize and code responses for further analysis.
            </p>
          </div>
      ...
      <div className='third-sub-body4'>
        <div className='sm:grid sm:grid-cols-2 sm:gap-4'>
          <div className='sm:col-span-1 '>
            ...
            <p className='footer2-p'>When dealing with multiple sources or long interviews, a transcript spreadsheet can help quickly find quotes, compare statements, and organize storylines.
            </p>
          </div>
          <div className='sm:col-span-1 '>
